...
LFLAGS = -lm
C_INCLUDE_PATH = gtd_fact_tree/inc:gtd_log/inc:gtd_common/inc
BIN_PATH = build/bin
OBJ_PATH = build/obj
MAIN_OBJ_FILES = main.o fact_tree.o fact.o contradiction.o implication.o log.o common.o fact_tree_machine.o
