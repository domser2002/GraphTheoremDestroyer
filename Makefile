...
BIN_PATH = build/bin
OBJ_PATH = build/obj
MAIN_OBJ_FILES = main.o graph.o fact.o contradiction.o implication.o log.o common.o machine.o physical_graph.o generative_proof_machine.o proof_tree.o
TEST_OBJ_FILES = unit_test.o test_fact_tree.o fact.o contradiction.o implication.o common.o log.o test_physical_graph.o physical_graph.o test_generative_proof_machine.o generative_proof_machine.o generative_restriction.o proof_tree.o
